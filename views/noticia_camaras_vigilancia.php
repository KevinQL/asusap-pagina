...
<html lang="en">
    ...
    <body>
        ...
        <div class="container noticia-pagina">
            ...
            <h1 class="text-center">IMPLEMENTACIÓN DE CÁMARAS DE VIGILANCIA</h1>
            ...
            Instalación de cámaras de videovigilancia en reservorios principales de aymarapata y huasipara con monitoreo desde el local de institucional.
            </p>
