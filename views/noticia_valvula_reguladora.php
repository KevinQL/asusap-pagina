...
<html lang="en">
    ...
    <body>
        ...
        <div class="container noticia-pagina">
            ...
            <h1 class="text-center">INSTALACIÓN DE VÁLVULAS REGULADORAS</h1>

            <section class="noticia-imagen">
                <img src="public/images/asusap/valvula_control.jpg" alt="" class="">
            </section>

            <p class="noticia-descripcion">
            Instalación de válvulas reguladoras de control y de aire de agua por manzanas en las arterias del área urbano para una mejor distribución del recurso hídrico. 
            </p>

            <section class="row noticia-fotos">
                <div class="col-md-3">
                    <img src="public/images/asusap/valvula_control.jpg" alt="" class="img-fluid w-100">
                </div>
                <!--<div class="col-md-3">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="public/images/asusap/valvula_control.jpg" class="" alt="...">
                        </div>
